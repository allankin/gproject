 ...
 */
public class TxlHorizontalScrollView extends HorizontalScrollView {
    public TxlHorizontalScrollView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public TxlHorizontalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public TxlHorizontalScrollView(Context context) {
        super(context);
        init(context);
    }
    ...
    class MyOnGlobalLayoutListener implements OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            final HorizontalScrollView me = TxlHorizontalScrollView.this;
            ...
            for (int i = 0; i < children.length; i++) {
                ...
                //dims[0], dims[1]
                /*if(i==0){
                	parent.addView(children[i],0,dims[1]);
                }else{
